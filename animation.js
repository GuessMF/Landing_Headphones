...
//     this.settings.mobile === undefined ? false : this.settings.mobile;
//   this.referenceElement =
//     this.settings.reference === undefined
//       ? window
//       : this.get(this.settings.reference)[0];
//   this.elements = [];
//   this.data = {};
...
//     return {
//       action: "enter",
//       data: {shown: this.data[elem.getAttribute("data-skroll-id")].shown},
//     };
//   } else {
...
//         var top =
//           _this.referenceElement == window
//             ? offset.top + _this.referenceElement.scrollY
//             : offset.top + _this.referenceElement.scrollTop;
...
//       if (
//         typeof val.settings.animation == "string" &&
//         val.settings.animation != "none"
//       ) {
//         if (!_this.animations[val.settings.animation]) {
//           console.warn(
//             "The requested animation '%s' was not found switching to default zoomIn",
...
//     _this.referenceElement.addEventListener(
//       event,
...
//               ) {
//                 e.style["transition"] =
//                   "all " + val.settings.duration + "ms " + val.settings.easing;
//                 setTimeout(function () {
